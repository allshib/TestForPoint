...
namespace TestForPoint
{
    public partial class PointForm : Form
    {
        ...
        private void bthSort_Click_1(object sender, EventArgs e)
        {
            if (points == null)
                return;
        ...
        private void bthSerialize_Click_1(object sender, EventArgs e)
        {
        ...
        private void bthDeserialize_Click_1(object sender, EventArgs e)
        {
